...
export default function Leads() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingLead) { await updateItem('leads', editingLead.id, data); addToast('Lead atualizado!'); }
      else { await addItem('leads', { ...data, dataEntrada: new Date().toISOString() }); addToast('Lead criado!'); }
      setShowModal(false);
    } catch (error) {
